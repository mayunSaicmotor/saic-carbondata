...
import org.apache.carbondata.scan.result.impl.NonFilterQueryScannedResultForSort;
 ...
 */
public class NonFilterScannerForSort extends AbstractBlockletScanner {

  public NonFilterScannerForSort(BlockExecutionInfo blockExecutionInfo) {
    super(blockExecutionInfo);
    // as its a non filter query creating a non filter query scanned result object
    //TODO
    scannedResult = new NonFilterQueryScannedResultForSort(blockExecutionInfo);
  }
}
