 ...
 */
public class DictionaryBasedResultCollectorForSort extends AbstractScannedResultCollector {
	
	protected String stopKey;

  private static final LogService LOGGER =
      LogServiceFactory.getLogService(DictionaryBasedResultCollectorForSort.class.getName());

  public DictionaryBasedResultCollectorForSort(BlockExecutionInfo blockExecutionInfos) {
   ...
   */
  //TODO
  @Override public List<Object[]> collectSortedData(AbstractScannedResult scannedResult, int batchSize, String stopKey) {
	  
	  this.stopKey = stopKey;
	 return collectData( scannedResult,  batchSize);
  }
  ...
  @Override public List<Object[]> collectData(AbstractScannedResult scannedResult, int batchSize) {
    ...
    //scannedResult.resetPauseProcessForSortFlg();
    
    while (scannedResult.hasNextForSort() && rowCounter < batchSize){
    		//&& ((!scannedResult.isPauseProcessForSortFlg() && rowCounter < batchSize)
    		//		||(scannedResult.isPauseProcessForSortFlg() && rowCounter < batchSize ))
    		//){
      Object[] row = new Object[dimSize + queryMeasures.length];
      
//	  if(scannedResult.getCurrentRow() == scannedResult.getRowMapping().length - 1 && scannedResult.getCurrentRow() == 6){
//		  row =row;
//	  }
...
//        if(scannedResult.isSortByNoDictionaryDimensionFlg() && noDictionaryKeys == null ){
//        	scannedResult.setPausedCompleteKey(surrogateResult); 
//        	break;
//        }
...
//    for(Object[] data : listBasedResult){
